...
- Different shapes of sound; sharp, round, etc. "Kiki" vs "Bobo"
...
- Consider Psychoacoustics... Identical noise… if one side happens earlier it reads as closer. So the noise is further away until it's suddenly two
- Brain is used to sounds bouncing off carpets and walls
- Reverb – echoes in a room
- Intimacy of voice - radio production - Mic placement! 
...
- Noise floor demo. The floor is the lowest thing you're picking up– the ambient noise 
